...
public class OpenVPNThread implements Runnable {
    ...
    private void startOpenVPNThreadArgs(String[] argv) {
        ...
        Log.d(TAG, "argv "+argv);
        Log.d(TAG, "argvlist "+argvlist);
        Collections.addAll(argvlist, argv);

        Log.d(TAG, "Collection..... "+argvlist);
        ProcessBuilder pb = new ProcessBuilder(argvlist);
        // Hack O rama

        String lbpath = genLibraryPath(argv, pb);
        Log.d(TAG, "lbpath1 "+lbpath);

        Log.d(TAG, "startOpenVPNThreadArgs: Getting Lib Path "+lbpath+",,,"+mTmpDir);
        ...
        try {
            Log.d(TAG, "startOpenVPNThreadArgs: Libbssssssss Wala try "+lbpath);
            mProcess = pb.start();
            Log.d(TAG, "startOpenVPNThreadArgs: Libbssssssss Wala try pb.start k bd"+lbpath);
            ...
            Log.d(TAG+" Waqar",e.toString());
            VpnStatus.logException("Error reading from output of OpenVPN process", e);
            Log.d(TAG, "startOpenVPNThreadArgs: Libbssssssss cATCHH"+lbpath);
            stopProcess();
        }
    ...
    private String genLibraryPath(String[] argv, ProcessBuilder pb) {
        ...
        Log.d(TAG,"AppLibPath : "+ applibpath);

        String lbpath = pb.environment().get("LD_LIBRARY_PATH");
        Log.d(TAG,"lbpath : "+ lbpath);
