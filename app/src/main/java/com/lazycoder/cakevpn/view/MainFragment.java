...
public class MainFragment extends Fragment implements View.OnClickListener, ChangeServer {
        ...
        switch (v.getId()) {
            case R.id.vpnBtn:
                ...
                if (vpnStart) {
                    ...
                    //Toast.makeText(getContext(), "Hello N chanlna mene", Toast.LENGTH_SHORT).show();
                    prepareVpn();
                }
        }
    }
    ...
    private void prepareVpn() {
        if (!vpnStart) {
            if (getInternetStatus()) {
                ...
                Toast.makeText(getContext(), "Prepare function working", Toast.LENGTH_SHORT).show();
                if (intent != null) {
                    startActivityForResult(intent, 1);
                    Toast.makeText(getContext(), "intent not null", Toast.LENGTH_SHORT).show();
    ...
    private void startVpn() {
        try {
            ...
            Toast.makeText(getContext(), "Ovpn file found", Toast.LENGTH_SHORT).show();
